<?php
    ...
    include '../components/Site__url.php';
    $data = '';
    $payment_id = '';
    if(isset($_GET['id'])){
        $payment_id = $_GET['id'];
...
<head>
    ...
    <title>SFP Ngo Donation Slip</title>
    <!-- Google Font -->
...
<body>
    <!-- Donation Slip -->
        <div class="container d-flex">
            <div class="print">
                <a href="<?php echo SITE__PATH; ?>/pages/Donation__Form.php?type=n"><button type="button" class="btn">Back</button></a> <button type="button" class="btn pl-2" onclick="window.print()">Print Slip Now</button>
            </div>
            <div class="border">
                <div class="heading">
                    <div class="logo">
                        <a href="index.php"><i class="fas fa-hands-helping"></i> <span>SPF NGO</span></a>
                ...
                <div class="donationSlipDody d-flex justify-content center">
                    ...
                    <div class="donate_info">
                        <ul>
                            ...
                            <li>
                                <?php echo date("d F Y h : i : s", strtotime($data['donate_on'])) ?>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="footer">
                    <div class="logo">
                        ...
                        <p><i class="far fa-envelope"></i> <span>example@spfngo.com</span></p>
                    </div>
                </div>
            </div>
            <div class="print">
